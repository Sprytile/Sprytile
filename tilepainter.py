...
# Access the following to get the texture slot of the material
# bpy.data.materials[0].texture_slots[0]
...
class TilePaintPanel(bpy.types.Panel):
    bl_label = "Tile Painting"
    bl_idname = "tilepaint.panel"
    bl_space_type = "VIEW_3D"
    bl_region_type = "TOOLS"
    bl_category = "Tilepaint"
